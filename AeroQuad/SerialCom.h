...
void fastTelemetry()
{
  ...
  if (motorArmed == ON) {
      ...
      if (i == 100){
        ...
        /* GPS */
        // Serial1.printNumber(currentPosition.latitude, 10);
        // Serial1.print("\t");
        // Serial1.printNumber(currentPosition.longitude, 10);
        // Serial1.print("\t");
        //unsigned long long x;
        //Serial1.printNumber(currentPosition.altitude, 10);
         
        
        /* Gyroscope Rates */
        //Serial1.println("rollRate pitchRate, yawRate, longitudinalAccel, lateralAccel, verticalAccel");
        //sprintf(numString, "%lf\n", gyroRate[YAXIS]);
        //Serial1.print(numString);
/*
        Serial1.printFloat(gyroRate[XAXIS],10); Serial1.print(" ");
        Serial1.printFloat(gyroRate[YAXIS],10); Serial1.print(" ");
        Serial1.printFloat(gyroRate[ZAXIS],10); Serial1.print(" ");
        Serial1.printFloat(filteredAccel[XAXIS],10); Serial1.print(" ");
        Serial1.printFloat(filteredAccel[YAXIS],10); Serial1.print(" ");
        Serial1.printFloat(filteredAccel[ZAXIS],10); Serial1.print("\n");*/
